...
const COMMANDS = {
  ...
  skills: () => [
    ...
    'AE:        Data Modeling, Semantic Layer Design, ERD Design, IoT / Sensor Data',
    'BI:        Looker, Power BI, QlikSense, QlikView, Metabase',
    'ETL:       Airflow, Talend',
  ...
  experience: () => [
    ...
    '  Nov 2023 – Present',
    '  Looker dashboards, LookML, BigQuery SQL optimization',
    '',
    '→ Analytics Engineer (Side Project) @ ADREA',
    '  Apr 2024 – May 2026  |  Remote',
    '  Postgres schema, IoT sensor data, Metabase dashboards',
    '',
    '→ BI Developer @ Globemed Group',
    '  Jun 2022 – Nov 2023',
    '  QlikSense/View, Talend ETL, Oracle PL/SQL',
    '',
